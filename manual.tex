...
我们建议您使用[PDF]\LaTeX\ 编译。用\XeLaTeX\ 编译可能会报错%与前两种方法相比，\XeLaTeX\  编译长文档的速度更快，
...
注意：使用 \XeLaTeX\ 编译时，\XeTeX\ 的版本应不低于 0.9995.0(MiKTeX 最低版本4.2 或者 TeXLive 2019以上)。
...
参考文献引用:
\cite{Nadkarni-1992,ChenCheChen2001,Ding}
\cite{ZhuKeZhen,Huo,Example}\cite{JiangXiZhou,Timoshenko,Zhang-Wang,GB6447-86}
